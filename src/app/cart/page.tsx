...
export default function CartPage() {
  ...
  // Auto-dismiss the "Cart cleared" toast after a couple of seconds.
  useEffect(() => {
    if (!showClearedToast) return;
    const timer = setTimeout(() => setShowClearedToast(false), 2500);
  ...
  return (
    <>
      ...
      >
        <div className="glass-panel px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest text-white shadow-lg border border-white/10">
          Cart Cleared
        </div>
      </div>
